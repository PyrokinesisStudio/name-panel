...
class panel(PropertyGroup):
  ...
  selected = BoolProperty(
    ...
    description = 'Display all possible object datablock names within your current selection inside the item panel.',
    default = False
  )
  ...
  constraints = BoolProperty(
    ...
    description = 'Display object constraint names.',
    default = False
  )
  ...
  modifiers = BoolProperty(
    ...
    description = 'Display object modifier names.',
    default = False
  )
...
class batch():
  ...
  class name(PropertyGroup):
    ...
    find = StringProperty(
      name = 'Find',
      description = 'Find this text and remove it.'
    )
    ...
    trimStart = IntProperty(
      name = 'Trim Start',
      description = 'Trim the beginning.',
      min = 0,
      max = 50,
      default = 0
    )
