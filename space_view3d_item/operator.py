...
class batch():
  ...
  class reset(Operator):
    ...
    '''
    bl_idname = 'view3d.batch_reset'
    bl_label = 'Reset Settings'
    bl_description = 'Reset operator options to their default values.'
    bl_options = {'REGISTER', 'UNDO'}
    ...
    copy = BoolProperty(
      ...
      description = 'Reset the option values for copy name.',
      default = True
    )
    ...
    def execute(self, context):
      ...
      # reset
      function.batch.reset(context, self.auto, self.names, self.name, self.copy)
      return {'FINISHED'}

  # transfer
  class transfer(Operator):
    '''
      Transfer batch operator propertie values.
    '''
    bl_idname = 'view3d.batch_transfer'
    ...
    copy = BoolProperty(
      name = 'Batch Copy Name',
      description = 'Transfer the option values for copy name.',
      default = True
    )
